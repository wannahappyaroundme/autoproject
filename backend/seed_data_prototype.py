...
async def seed():
    ...
    async with async_session() as session:
        ...
        # 로봇 2대
        robots = [
            Robot(name="로봇-A", state="idle", battery=100.0, position_x=3.0, position_y=26.0, color="#ef4444"),
            Robot(name="로봇-B", state="idle", battery=100.0, position_x=36.0, position_y=26.0, color="#3b82f6"),
        ]
