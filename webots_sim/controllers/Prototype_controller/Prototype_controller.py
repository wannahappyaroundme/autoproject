...
# 시제품 스펙 상수
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
GRID_W, GRID_H = 30, 20              # 웹 시뮬레이션과 동일
CELL_M = 0.5                          # 1셀 = 0.5m (테스트 랩 규모)
CP = (15, 2)                          # 수거함 (그리드 좌표)
NUM_ROBOTS = 2
...
def build_grid():
    ...
    # 장애물
    wall(12, 8, 16, 11)   # 중앙 테이블
    wall(3, 8, 4, 12)     # 왼쪽 선반
    wall(25, 11, 27, 14)  # 오른쪽 캐비닛
    wall(14, 1, 16, 1)    # 수거함 벽
